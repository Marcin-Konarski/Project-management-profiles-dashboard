...
@pytest.fixture
def fake_project_with_documents_payload(fake_project_payload, fake_document_1_payload, fake_document_2_payload):
    return {**fake_project_payload, "documents": [fake_document_1_payload, fake_document_2_payload]}
